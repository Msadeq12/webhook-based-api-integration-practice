        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProductionStudioId = table.Column<int>(type: "int", nullable: false),
                    StreamingRights = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "MovieId", "GenreId", "Name", "ProductionStudioId", "Rating", "StreamingRights", "Year" },
                values: new object[,]
                {
                    { 1, "D", "Casablanca", 1, 5, "Actively Streaming", 1942 },
                    { 2, "A", "Apocalypse Now", 4, 4, "Actively Streaming", 1979 },
                    { 3, "C", "Annie Hall", 3, 5, "Actively Streaming", 1977 }
                });
